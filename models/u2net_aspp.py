...
class U2netLiteAsppGenerator(nn.Module):
    ...
    def __init__(self, input_nc: int, output_nc: int, norm_layer=nn.BatchNorm2d):
        ...
        """
        super(U2netLiteAsppGenerator, self).__init__()
        self.model = u2net_lite_aspp(input_nc, output_nc, norm_layer)
...
def u2net_lite_aspp(input_nc: int, output_nc: int, norm_layer=nn.BatchNorm2d):
    cfg = {
